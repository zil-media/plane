...
export const meta = () => [
  { title: "Zil Ops | Gestión de proyectos" },
  { name: "description", content: SITE_DESCRIPTION },
  {
    name: "keywords",
    content: "gestión de proyectos, tareas, ciclos, roadmap, colaboración, equipo, zil, project management",
  },
  {
    name: "viewport",
    content:
  ...
  { property: "og:title", content: "Zil Ops | Gestión de proyectos" },
  {
    property: "og:description",
    content: "Zil Ops — plataforma interna de gestión de proyectos y trabajo del equipo.",
  },
  { property: "og:url", content: "https://app.plane.so/" },
  { property: "og:image", content: "https://app.plane.so/og-image.png" },
  { property: "og:image:width", content: "1200" },
  { property: "og:image:height", content: "630" },
  { property: "og:image:alt", content: "Zil" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: "https://app.plane.so/og-image.png" },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Zil" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Zil" />
