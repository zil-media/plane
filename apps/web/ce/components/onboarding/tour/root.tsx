...
const TOUR_STEPS: {
...
}[] = [
  {
    ...
    description:
      "The work item is the building block of Zil Ops. Most concepts in Zil Ops are either associated with work items and their properties.",
    image: IssuesTour,
    nextStep: "cycles",
  },
  {
          ...
          <div className="h-full overflow-hidden">
            ...
            <div className="flex flex-col overflow-y-auto p-6">
              <h3 className="font-semibold sm:text-18">
                Welcome to Zil Ops, {currentUser?.first_name} {currentUser?.last_name}
              </h3>
              <p className="mt-3 text-13 text-secondary">
                We{"'"}re glad that you decided to try out Zil Ops. You can now manage your projects with ease. Get
